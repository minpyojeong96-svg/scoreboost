...

{
  ...
  "blocks": {
    ...
    "B": "문장의 핵심 단어 3~5개를 '단어 → 뜻 → 한 줄 설명' 형식으로. 예:\n• washed → 씻었다 (wash의 과거형이에요)\n• dishes → 접시들 (dish 하나, dishes 여러 개!)",
    "C": "문장을 주어/동사/목적어로 나눠서 설명. 예:\n주어(누가): She → 그녀가\n동사(어쨌다): washed → 씻었다\n목적어(무엇을): the dishes → 접시들을\n→ 그녀가 / 접시들을 / 씻었다",
    "D": "이 문장에서 배울 문법 포인트를 단계별로 설명. ①②③ 번호를 붙여서 초등학생도 이해하게. 어려운 용어는 반드시 쉬운 말로 풀어서. (문법 포인트 없으면 이 항목 제외)",
    "E": "왜 이렇게 쓰는지 이유를 일상 예시와 함께 설명. '예를 들어 우리말로는 ~라고 하잖아요. 영어도 똑같이...' 식으로. (단순한 문장이면 제외)",
    "F": "헷갈리기 쉬운 틀린 표현과 맞는 표현 비교. ❌ 틀린 예 + 왜 틀렸는지 한 줄 / ✅ 맞는 표현. (비교할 게 없으면 제외)",
