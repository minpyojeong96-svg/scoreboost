...

{
  ...
  "blocks": {
    ...
    "G": "이 문장의 핵심 문법 패턴을 활용해 새로운 문장을 만들고 그 안의 핵심 단어 하나를 ___ 빈칸으로 만든 문제 1개. 원본과 같은 문법 구조이지만 다른 주제/상황 사용. 반드시 마지막에 (정답단어) 형식. 예시 - 원본: She washed the dishes. → 문제: My brother ___ his car every weekend. (washes)"
  }
}`
